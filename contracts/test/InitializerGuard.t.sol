...
contract InitializerGuardTest is AgenticIDTestBase {
    function test_proxy_cannotReinitialize() public {
        ...
        agenticId.initialize("x", "x", address(verifier), owner, pauser, MAX_PROOF_AGE, address(canonical));
    }
    ...
    function test_implementation_initializeDisabled() public {
        ...
        vm.expectRevert(Initializable.InvalidInitialization.selector);
        impl.initialize("x", "x", address(verifier), owner, pauser, MAX_PROOF_AGE, address(canonical));
